			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="themlichtkb">
						<form method="POST" action="${contextPath}/import/create"  enctype="multipart/form-data" modelAttribute="importCreate">
							<input type="text" list="cars" class="form-control" name="calendarId"/>
							<datalist id="cars">
								<option>Volvo</option>
								<option>Saab</option>
