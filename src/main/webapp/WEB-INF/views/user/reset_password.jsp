				...
				<div class="mt-4 d-flex justify-content-center form_container quenmatkhau">
					<form id="reset-pass-form" method="post">
						...
						<div class="input-group mb-3">
							...
							<input id="password" type="text" name="password" class="form-control input_user" placeholder="Nhập mật khẩu mới">
						</div>
						...
						<div class="input-group mb-3">
							...
							<input id="passwordConfirm" type="text" name="passwordConfirm" class="form-control input_user" placeholder="Nhập lại mật khẩu">
						</div>
					</form>
				</div>
