		...
		<div class="row" style="margin:0">
			<div class="col-md-6">
				<div class="row" style="margin:0">
					...
					<p>Copyright © 2019 <a href="https://st-dse.vnua.edu.vn/" target="_blank">ST-DSE</a>. All rights reserved.<br />Địa chỉ: P.310A, Tầng 3, Nhà hành chính, Học viện Nông nghiệp Việt Nam</p>
					<!-- <p></p> -->
					</div>
				</div>
			</div>
